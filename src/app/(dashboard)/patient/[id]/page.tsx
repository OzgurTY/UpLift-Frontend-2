            ...
            <div className='w-full xl:w-2/3'>
                ...
                <div className='flex flex-col lg:flex-row gap-4'>
                    ...
                    <div className='bg-upliftSky py-6 px-4 rounded-md flex-1 flex gap-4'>
                        <div className='w-1/3'>
                            <Image src="https://images.pexels.com/photos/936225/pexels-photo-936225.jpeg?auto=compress&cs=tinysrgb&w=2100" alt='' width={144} height={144} className='w-36 h-36 rounded-full object-cover' />
                        </div>
